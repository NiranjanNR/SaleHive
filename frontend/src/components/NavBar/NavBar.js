    ...
    <div className=' mt-1 bg-white z-index'>
      <div className="mx-4 ">
        <div className='py-4 flex justify-center items-center text-slate-100'>
          <button>
            <Link to={`/`} className='text-3xl ml-10 font-extrabold text-gray-800 lg:text-4xl xl:text-5xl logo-font'>
              SaleHive
            </Link>
          </button>
          <div className='hidden md:flex font-semibold text-md mr-auto ml-20 text-gray-500'>
            <div>
              ...
              <Link to="/cart">
                <button className='hover:text-[rgb(123,63,0)] px-5 pb-1 transition-all ease-in-out active:scale-95 hover-underline-animation'>Cart</button>
              </Link>
              <button onClick={() => onLogout()} className='hover:text-[rgb(123,63,0)] px-5 pb-1 transition-all ease-in-out active:scale-95 hover-underline-animation'>Logout</button>
            </div>
          </div>
          <div className={`md:hidden absolute top-16 z-50 right-0 bg-[rgba(249,251,253)] w-full ${isMenuOpen ? '' : 'hidden'}`}>
            <div className='flex flex-col items-center text-lg py-2'>
              ...
              <Link to="/" className='hover:text-pink-600/75 my-2'>
              ...
              <Link to="/cart" className='hover:text-pink-600/75 my-2'>
                <button className='hover:text-pink-600/75 my-2'>Cart</button>
              </Link>
              <button onClick={() => onLogout()} className='hover:text-pink-600/75 my-2'>Logout</button>
            </div>
          </div>
          <div className="ml-auto flex items-center">
            <div className="hidden md:flex">
              <input
                className={`px-8 py-2 placeholder:text-md text-md font-light placeholder:text-gray-600/80 rounded-lg bg-gray-200/40`}
